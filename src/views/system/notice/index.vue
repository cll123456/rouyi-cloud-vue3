...
<template>
   <div class="app-container">
      ...
      <el-row :gutter="10" class="mb8">
         <el-col :span="1.5">
            <el-button type="primary" plain :icon="Plus" @click="handleAdd" v-hasPermi="['system:notice:add']">新增
            </el-button>
         </el-col>
         <el-col :span="1.5">
            ...
            <el-row>
               ...
               <el-col :span="24">
                  <el-form-item label="内容">
                     <!-- todo 这个地方可以换成富文本框 -->
                     <el-input :rows="2" type="textarea" placeholder="请输入通知内容" v-model="form.noticeContent" />

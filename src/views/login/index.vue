  ...
  <div class="login">
    <el-form ref="loginFormRef" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item prop="username">
        <el-input v-model="loginForm.username" size="large" type="primary" link auto-complete="off" placeholder="账号">
      ...
      <el-form-item prop="code" v-if="captchaOnOff">
        <el-input v-model="loginForm.code" auto-complete="off" size="large" placeholder="验证码" style="width: 63%"

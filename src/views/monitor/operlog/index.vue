...
<template>
   <div class="app-container">
      ...
      <el-row :gutter="10" class="mb8">
         ...
         <el-col :span="1.5">
            <el-button type="danger" plain :icon="DeleteFilled" @click="handleClean"
      ...
      <el-table ref="tablesRef" v-loading="loading" :data="dataList" @selection-change="handleSelectionChange"
         ...
         <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
               <el-button type="primary" link :icon="View" @click="handleView(scope.row, scope.index)"

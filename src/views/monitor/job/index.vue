...
const handleStatusChange = (row) => {
   ...
   MessageBox.confirm('确认要"' + text + '""' + row.jobName + '"任务吗?', "警告", {
...
/* 立即执行一次 */
const handleRun = (row) => {
   MessageBox.confirm('确认要立即执行一次"' + row.jobName + '"任务吗?', "警告", {
      confirmButtonText: "确定",
      cancelButtonText: "取消",
      type: "warning"
   }).then(function () {
...
const handleDelete = (row) => {
   ...
   MessageBox.confirm('是否确认删除定时任务编号为"' + jobIds + '"的数据项?', "警告", {
      confirmButtonText: "确定",
      cancelButtonText: "取消",
      type: "warning"
   }).then(function () {
...
/** 导出按钮操作 */
const handleExport = () => {
   MessageBox.confirm('是否确认导出所有定时任务数据项?', "警告", {
      confirmButtonText: "确定",
      cancelButtonText: "取消",
      type: "warning"
   }).then(function () {
